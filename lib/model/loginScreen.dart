          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                  ...
                  onPressed: () async {
                    var res = await ApiManager.login(emailController.text,
                        passwordController.text, "/doctor/loginDoctor") as DoctorAuthModel;
                    print(res.message);
                    if (res.message == "Done") {
                      var prefs = await SharedPreferences.getInstance();
                      prefs.setString('id', res.doctorIdToken?.id ?? '');
                      Navigator.of(context).pushNamed(HomeScreen.routeName);
                    } else if (res.message == "Please accept from admin.") {
