      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            GestureDetector(
              onTap: () {
                Navigator.of(context,rootNavigator: true).pushNamed(MotionRateScreen.routeName,
                    arguments: data.seizureHistory?.first.motionRate);
              },
              child: Container(
            ...
            GestureDetector(
              onTap: () {
                Navigator.of(context,rootNavigator: true).pushNamed(HeartRateScreen.routeName,
                    arguments: data.seizureHistory?.first.heartRate);
              },
              child: Container(
                margin: EdgeInsets.symmetric(horizontal: 24),
                decoration: BoxDecoration(
            ...
            GestureDetector(
              onTap: () {
                Navigator.of(context,rootNavigator: true).pushNamed(HistoryScreen.routeName,
